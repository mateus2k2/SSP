...
int SSP::modelo(string filenameoutput) {
    ...
    try {
        ...
        model.write(filenameoutput + "/testModel.lp");
        ...
        if (status == GRB_INFEASIBLE) {
            ...
            model.computeIIS();
            model.write(filenameoutput + "/InfeasibilityCheck.ilp");
            return 0;
        }
        ...
        model.write(filenameoutput + "/modelSolution.sol");
