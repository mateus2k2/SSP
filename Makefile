...
$(OBJ_DIR)/%.o: $(SRC_DIR)/%.cpp
	@mkdir -p $(OBJ_DIR)
	$(CXX) $(CXXFLAGS) ${OPTIMIZATION} $(SANITAZE) -MMD -MP -c $< -o $@ $(INCLUDES)

# Header dependencies generated by -MMD: without them a change to a header
# (e.g. a new field in SSP.h) recompiled nothing, and the object files were
# silently built against different versions of the class.
